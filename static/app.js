...
__app.bonus = {
    ...
    _buildElements: function() {
        ...
        cantstenchon = $('<div id="cant-stenchon" class="scrollable"><img class="img-content-drop-shadow" src="/static/img/special/cant-stenchon.png"><img class="layer" id="deal-with-it" src="/static/img/special/layer-deal-with-it.png"><img class="layer" id="thug-life" src="/static/img/special/layer-thug-life.png"><img class="layer" id="petard" src="/static/img/special/layer-petard.png"></div>');
    ...
    _preload: function() {
        ...
        var a = Modernizr.svg ? '.svg' : '.png',
            t = ['/static/img/special/cant-stenchon.png', '/static/img/special/layer-deal-with-it.png', '/static/img/special/layer-petard.png', '/static/img/special/layer-thug-life.png', '/static/img/special/0-crown' + a, '/static/img/special/1-keep' + a, '/static/img/special/2-calm' + a, '/static/img/special/3-and' + a, '/static/img/special/4-vote' + a, '/static/img/special/5-melenchon' + a, ],
            n = function() {
                var a = t.shift();
